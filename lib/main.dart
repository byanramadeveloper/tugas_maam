import 'package:tugas_maam/main.dart';
...
final baseTextSyle = const TextStyle(color: Colors.white, fontFamily: 'arial');
final bigHeaderTextStyle =
    baseTextSyle.copyWith(fontSize: 24.0, fontWeight: FontWeight.bold);
final descTextStyle =
    baseTextSyle.copyWith(fontSize: 18.0, fontWeight: FontWeight.w400);
final footerTextStyle =
    baseTextSyle.copyWith(fontSize: 14.0, fontWeight: FontWeight.w400);
...
class __PageStateListState extends State<_PageList> {
    ...
    return Container(
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            final material = bahan[index].toString();
            final tutor = resep[index].toString();
              ...
              child: GestureDetector(
                child: Stack(
                  children: <Widget>[
                    backgroundImage(img),
                    Container(
                      child: topContent(title, material, tutor),
                    )
                  ],
                ),
                onTap: () {
  ...
  topContent(String nama, String deskripsi, String stock) {
    return new Container(
      child: Column(
